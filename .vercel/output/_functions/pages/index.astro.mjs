import { c as createComponent, a as createAstro, m as maybeRenderHead, b as addAttribute, r as renderTemplate, d as renderComponent, k as renderScript } from '../chunks/astro/server_CDbgqzxC.mjs';
import 'kleur/colors';
import 'clsx';
...
const $$VideoThumbnail = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<img${addAttribute(src, "src")} alt="Video Thumbnail" class="rounded-xl border-2 w-64 h-40 border-primary-light transition-all duration-300 ease-in-out transform hover:shadow-[0_0_10px_1px_rgba(0,0,0,0.2)] hover:shadow-primary-light">`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/videoThumbnail.astro", void 0);
...
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/playIcon.astro", void 0);
...
const $$VideoButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const { src } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div id="video-play" class="relative group cursor-pointer"> ${renderComponent($$result, "VideoThumbnail", $$VideoThumbnail, { "src": src })} ${renderComponent($$result, "PlayIcon", $$PlayIcon, {})} </div>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/molecules/videoButton.astro", void 0);
...
const $$LogoTextImage = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<img${addAttribute(src, "src")}${addAttribute(alt, "alt")} loading="lazy"${addAttribute(`max-w-[85%] md:max-w-[60%] xl:max-w-[50%] h-auto ${className}`, "class")}>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/logoTextImage.astro", void 0);
...
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/ctaButton.astro", void 0);
...
const $$HeroContent = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="relative flex flex-col w-full min-h-full p-8 sm:p-8 rounded-2xl border-2 overflow-hidden border-none shadow-md dark:shadow-gray-400 shadow-gray-700"> <video${addAttribute(backgroundVideo, "src")} autoplay loop muted playsinline class="absolute top-0 left-0 w-full h-full object-cover z-10"></video> <div class="relative z-10 flex flex-col items-start gap-4 my-16"> ${renderComponent($$result, "LogoTextImage", $$LogoTextImage, { "src": logoTextUrl })} <p class="text-lg lg:text-2xl text-white w-1/2 text-center"> ${subtitle} </p> </div> <div class="absolute bottom-4 left-4 right-4 sm:bottom-6 md:left-10 md:right-10 z-20 flex flex-col items-center sm:items-end gap-10 sm:flex-row sm:justify-between"> ${renderComponent($$result, "VideoButton", $$VideoButton, { "src": src })} ${renderComponent($$result, "CtaButton", $$CtaButton, { "text": textCtaButton, "href": hrefCtaButton })} </div> </div>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/molecules/heroContent.astro", void 0);
...
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/closeModal.astro", void 0);
...
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/organisms/heroSection.astro", void 0);
...
const $$ImageCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="group relative overflow-hidden rounded-lg shadow-sm shadow-gray-600 dark:shadow-none w-full aspect-[4/3]"> <img${addAttribute(imageSrc, "src")}${addAttribute(title, "alt")} class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"> </div>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/imageCard.astro", void 0);
...
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/cardTitle.astro", void 0);
...
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/hoverLine.astro", void 0);
...
const $$ArrowButton = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")} class="flex items-center gap-2 group justify-center w-10 h-10 rounded-full border-2 border-gray-900 dark:border-gray-500 group-hover:border-primary transition-all duration-300"> ${label && renderTemplate`<span class="text-lg font-semibold">${label}</span>`} <i class="fa-solid fa-arrow-right text-gray-900 dark:text-gray-500 group-hover:text-primary transition-colors duration-300"></i> </a>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/arrowButton.astro", void 0);

const $$Astro$5 = createAstro();
const $$ServicesCard = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$5, $$props, $$slots);
  Astro2.self = $$ServicesCard;
  const { imageSrc, title, index } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="group relative flex flex-col gap-2"> ${renderComponent($$result, "ImageCard", $$ImageCard, { "imageSrc": imageSrc, "title": title })} <div class="flex items-center justify-between pt-2"> ${renderComponent($$result, "CardTitle", $$CardTitle, { "title": title, "index": index })} ${renderComponent($$result, "ArrowButton", $$ArrowButton, { "href": "/services" })} </div> <div class="pt-2"> ${renderComponent($$result, "HoverLine", $$HoverLine, {})} </div> </div>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/molecules/servicesCard.astro", void 0);

const $$Astro$4 = createAstro();
const $$ServicesTextGroup = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots);
  Astro2.self = $$ServicesTextGroup;
  const { name, description, url } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col md:flex-row gap-4 items-center justify-between w-full text-left"> <h2 class="text-3xl font-semibold text-primary dark:text-white">${name}</h2> <p class="text-gray-900 dark:text-gray-400 md:max-w-2/5 text-justify md:text-left"> ${description} </p> ${renderComponent($$result, "ViewMoreButton", $$ViewMoreButton, { "text": "Ver m\xE1s", "url": url })} </div>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/molecules/servicesTextGroup.astro", void 0);

const $$ServicesSection = createComponent(($$result, $$props, $$slots) => {
  const services = [
    {
      title: "Dise\xF1o Web",
      imageSrc: "/images/services/desarrollo.webp",
      index: 1
    },
    {
      title: "Desarrollo de Software",
      imageSrc: "/images/services/disenio.webp",
      index: 2
    },
    {
      title: "Inteligencia Artificial",
      imageSrc: "/images/services/inteligencia.webp",
      index: 3
    }
  ];
  ...
  const url = "/services";
  return renderTemplate`${maybeRenderHead()}<section class="py-14 px-6 md:px-12 lg:px-20"> <div class="flex flex-col gap-12 items-start"> ${renderComponent($$result, "ServicesTextGroup", $$ServicesTextGroup, { "name": sectionTitle, "description": sectionDescription, "url": url })} <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 flex-1"> ${services.map((service) => renderTemplate`${renderComponent($$result, "ServicesCard", $$ServicesCard, { "title": service.title, "imageSrc": service.imageSrc, "index": service.index })}`)} </div> </div> </section>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/organisms/servicesSection.astro", void 0);

const $$Astro$3 = createAstro();
const $$TechLogo = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$TechLogo;
  const { name, icon, color } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="flex items-center justify-center flex-shrink-0 w-36 sm:px-8 cursor-pointer"> <i${addAttribute(`${icon} text-4xl text-primary transition-transform duration-300 ${color} hover:scale-110`, "class")}${addAttribute(name, "title")}></i> </div>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/techLogo.astro", void 0);
  ...
  const logos = [
    {
      ...
      color: "hover:text-[#83CD29]"
    },
    // { name: "Next.js", icon: "fa-brands fa-node", color: "hover:text-[#000000]" },
    // {
    //   name: "MongoDB",
    ...
    //   name: "MySQL",
    //   icon: "fa-brands fa-database",
    //   color: "hover:text-[#00758F]",
    // },
    {
      name: "Python",
      icon: "fa-brands fa-python",
      color: "hover:text-[#FFE873]"
    },
    {
      name: "Docker",
      icon: "fa-brands fa-docker",
      color: "hover:text-[#0db7ed]"
    },
    { name: "Java", icon: "fa-brands fa-java", color: "hover:text-[#ED8B00]" },
    { name: "PHP", icon: "fa-brands fa-php", color: "hover:text-[#787CB5]" },
    { name: "React", icon: "fa-brands fa-react", color: "hover:text-[#61DBFB]" },
    {
      name: "Laravel",
    ...
    // },
    {
      ...
      color: "hover:text-[#444140]"
    }
  ];
  return renderTemplate`${maybeRenderHead()}<div class="relative w-full overflow-hidden py-8"> <div class="flex animate-[scroll_10s_linear_infinite] paused w-fit"> ${logos.map((logo) => renderTemplate`${renderComponent($$result, "TechLogo", $$TechLogo, { "name": logo.name, "icon": logo.icon, "color": logo.color })}`)} ${logos.map((logo) => renderTemplate`${renderComponent($$result, "TechLogo", $$TechLogo, { "name": logo.name, "icon": logo.icon, "color": logo.color })}`)} </div> </div>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/molecules/techCarousel.astro", void 0);
...
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/projectTitle.astro", void 0);
...
const $$ProjectCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")} class="group relative flex flex-col gap-2 cursor-pointer"> <div class="transition-all duration-300 hover:scale-105"> ${renderComponent($$result, "ImageCard", $$ImageCard, { "imageSrc": imageSrc, "title": title })} </div> <div class="flex items-start justify-between pt-2 gap-16"> ${renderComponent($$result, "ProjectTitle", $$ProjectTitle, { "title": title })} <p class="text-gray-900 dark:text-gray-500 text-right flex-1 leading-snug max-w-xs line-clamp-2"> ${shortDescription} </p> </div> </a>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/molecules/projectCard.astro", void 0);
...
const $$PortfolioSection = createComponent(($$result, $$props, $$slots) => {
  const projects = [
    ...
    },
    {
      ...
      shortDescription: "Plataforma para catalogar especies vegetales"
    }
  ];
  ...
  const url = "/portfolio";
  return renderTemplate`${maybeRenderHead()}<section class="py-14 px-6 md:px-12 lg:px-20"> <div class="flex flex-col gap-12 items-start"> ${renderComponent($$result, "ServicesTextGroup", $$ServicesTextGroup, { "name": sectionTitle, "description": sectionDescription, "url": url })} <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 flex-1"> ${projects.map((project) => renderTemplate`${renderComponent($$result, "ProjectCard", $$ProjectCard, { "title": project.title, "imageSrc": project.imageSrc, "shortDescription": project.shortDescription, "href": project.href })}`)} </div> </div> </section>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/organisms/portfolioSection.astro", void 0);
...
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/atoms/contactText.astro", void 0);

const $$ContactSection = createComponent(($$result, $$props, $$slots) => {
  const backgroundImage = "/images/home/contact.webp";
  const logoTextUrl = "/global/LOGO-AZUL-CLARO-TEXTO.webp";
  const message = "Se parte de nuestro equipo y construyamos juntos el futuro digital.";
  const textCtaButton = "Cotiza tu proyecto";
  const hrefCtaButton = getWhatsAppLink();
  return renderTemplate`${maybeRenderHead()}<section class="relative w-full min-h-screen overflow-hidden"> <img${addAttribute(backgroundImage, "src")} alt="Fondo seccional" class="absolute top-0 left-0 w-full h-full object-cover z-10"> <div class="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center gap-8"> ${renderComponent($$result, "LogoTextImage", $$LogoTextImage, { "src": logoTextUrl })} ${renderComponent($$result, "CtaButton", $$CtaButton, { "text": textCtaButton, "href": hrefCtaButton })} ${renderComponent($$result, "ContactText", $$ContactText, { "text": message })} </div> </section>`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/components/index/organisms/contactSection.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HeroSection", $$HeroSection, {})} ${renderComponent($$result2, "ServicesSection", $$ServicesSection, {})} ${renderComponent($$result2, "TechCarousel", $$TechCarousel, {})} ${renderComponent($$result2, "PortfolioSection", $$PortfolioSection, {})} ${renderComponent($$result2, "ContactSection", $$ContactSection, {})} ` })}`;
}, "D:/PrometeonDev/Landing-PrometeOnDev/src/pages/index.astro", void 0);

const $$file = "D:/PrometeonDev/Landing-PrometeOnDev/src/pages/index.astro";
const $$url = "";
