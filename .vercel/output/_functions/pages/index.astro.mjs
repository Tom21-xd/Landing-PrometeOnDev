...
const $$HeroContent = createComponent(($$result, $$props, $$slots) => {
  ...
  const src = "https://img.youtube.com/vi/-M_18UPW_Ns/maxresdefault.jpg";
...
const $$HeroSection = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="relative flex w-full min-h-screen overflow-hidden p-4"> ${renderComponent($$result, "HeroContent", $$HeroContent, {})} </section> ${renderComponent($$result, "VideoModal", $$VideoModal, { "videoSrc": "https://www.youtube.com/watch?v=-M_18UPW_Ns" })}`;
